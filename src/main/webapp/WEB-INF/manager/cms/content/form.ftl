        ...
        data: function () {
            return {
                ...
                editorConfig: {
                    ...
                    serverUrl: ms.base + "/static/plugins/ueditor/1.4.3.1/jsp/editor.do?jsonConfig=%7BvideoUrlPrefix:\'" + ms.base + "\',fileUrlPrefix:\'" + ms.base + "\',imageUrlPrefix:\'" + ms.base + "\',fileManagerListPath:\'/upload/${appId}/cms/content/editor\',imagePathFormat:\'/upload/${appId}/cms/content/editor/%7Btime%7D\',filePathFormat:\'/upload/${appId}/cms/content/editor/%7Btime%7D\',videoPathFormat:\'/upload/${appId}/cms/content/editor/%7Btime%7D\'%7D",
                ...
                rules: {
                    ...
                    contentTitle: [{
                        "required": true,
                        "message": "请选择文章标题"
                    }, {"min":0,"max":255,"message":"标题长度必须为0-255"}],
                    // 发布时间
                    contentDatetime: [{
                        "required": true,
                        "message": "发布时间不能为空"
                    ...
                    contentDescription: [{
                        "min":0,"max":400,"message":"描述长度必须为0-400"
                    }]
                }
            };
        },
            ...
            contentCategoryIdOptionsGet: function () {
                ...
                ms.http.get(ms.manager + "/cms/category/list.do", {
                    ...
                    if (res.result) {
                        ...
                        console.log('contentCategoryIdOptions:', that.contentCategoryIdOptions);
