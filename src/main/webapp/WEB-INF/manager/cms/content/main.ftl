            ...
            <el-form :model="form"  ref="searchForm"  label-width="120px" size="mini">
                <el-row>
                    ...
                    <el-col :span="8" style="text-align: right;padding-right: 10px;">
                        ...
                        <el-button type="primary" size="mini" @click="handleExportXls('导出文章.xls')">导出</el-button>
                    </el-col>
                </el-row>
            </el-form>
        </el-row>
    ...
    var indexVue = new Vue({
        ...
        methods: {
            handleExportXls(fileName){
				...
				const param = {}
				ms.http.download(ms.manager + '/cms/content/exportXls', param, fileName)
			},
            //查询列表
            list: function () {
                var that = this;
            ...
            currentChange: function (currentPage) {
                ...
                history.pushState(null, "", window.location + "?page=" + currentPage);
                //window.parent.indexVue.changePage(currentPage);
                this.loading = true;
        ...
        mounted: function () {
            ...
            this.currentPage = Number(ms.util.getParameter("page"));
            console.log('currentPage:', this.currentPage);
            if (history.hasOwnProperty("state")) {
                console.log('history has state');
